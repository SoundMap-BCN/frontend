  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] text-white flex flex-col">
      ...
      <main className="flex-grow px-4 py-10">
        <div className="max-w-5xl mx-auto bg-[#241f2e] p-8 rounded-3xl shadow-xl border border-white/5">

          {/* TITLE + DATE */}
          <h1 className="text-2xl font-bold">PlacadelSolatMidnight</h1>
          <p className="text-gray-400 text-sm mb-6">
            Recorded on August 12, 2023 — 2:30 min
          </p>

          {/* WAVEFORM FAKE */}
          <div className="w-full h-24 bg-gradient-to-r from-purple-300/20 to-purple-500/20 rounded-lg mb-4" />
